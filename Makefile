...
OBJECTS += ./mbed-os/components/802.15.4_RF/atmel-rf-driver/source/NanostackRfPhyAT86RF215.o
...
OBJECTS += ./mbed-os/features/mbedtls/targets/TARGET_STM/TARGET_STM32F4/aes_alt.o
...
OBJECTS += ./mbed-os/features/nanostack/sal-stack-nanostack/source/6LoWPAN/ws/ws_cfg_settings.o
...
OBJECTS += ./mbed-os/features/netsocket/emac-drivers/TARGET_STM/TARGET_STM32F4/TARGET_NUCLEO_F429ZI/stm32f4_eth_conf.o
OBJECTS += ./mbed-os/features/netsocket/emac-drivers/TARGET_STM/TARGET_STM32F4/TARGET_NUCLEO_F429ZI/stm32f4_eth_init.o
...
INCLUDE_PATHS += -I../D:/work/FT.S_GPIO/mbed-os
...
C_FLAGS += -D__MBED__=1
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1588333282.2
...
C_FLAGS += -DTARGET_NAME=NUCLEO_F429ZI
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1588333282.2
...
CXX_FLAGS += -DTARGET_NAME=NUCLEO_F429ZI
...
ASM_FLAGS += -I..\mbed-os\features\cellular\framework\targets\Altair
ASM_FLAGS += -I..\mbed-os\features\cellular\framework\targets\Altair\ALT1250
ASM_FLAGS += -I..\mbed-os\features\cellular\framework\targets\Altair\ALT1250\PPP
...
ASM_FLAGS += -I..\mbed-os\features\mbedtls\targets\TARGET_STM\TARGET_STM32F4
ASM_FLAGS += -I..\mbed-os\features\nanostack
...
ASM_FLAGS += -I..\mbed-os\features\netsocket\emac-drivers\TARGET_STM\TARGET_STM32F4
ASM_FLAGS += -I..\mbed-os\features\netsocket\ppp
...
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F4\TARGET_STM32F429xI
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F4\TARGET_STM32F429xI\TARGET_NUCLEO_F429ZI
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F4\TARGET_STM32F429xI\device
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F4\device
ASM_FLAGS += -ID:\work\FT.S_GPIO\mbed-os
ASM_FLAGS += -include
